            ...
            <ul class="navbar-nav d-flex flex-row">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="display_all.php?sort_by=title">Product Title</a></li>
                        <li><a class="dropdown-item" href="display_all.php?sort_by=date">Newest to Oldest</a></li>
                        <li><a class="dropdown-item" href="display_all.php?sort_by=date_asc">Oldest to Newest</a></li>
                    </ul>
                </li>
            </ul>
        </div>
